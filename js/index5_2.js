...
// console.log('sort by color of eyes:', getUsersByEyeColor(users, 'blue')); // [объект Moore Hensley, объект Sharlene Bush, объект Carey Barr]
...
// console.log('sort by gender', getUsersByGender(users, 'male')); // [ 'Moore Hensley', 'Ross Vazquez', 'Carey Barr', 'Blackburn Dotson' ]
...
// console.log('Not active users', getInactiveUsers(users)); // [объект Moore Hensley, объект Ross Vazquez, объект Blackburn Dotson]
...
// console.log('find by Email 1', getUserByEmail(users, 'shereeanthony@kog.com')); // {объект пользователя Sheree Anthony}
// console.log('find by Email 2', getUserByEmail(users, 'elmahead@omatom.com')); // {объект пользователя Elma Head}
...
// console.log('Users between 20 and 30', getUsersWithAge(users, 20, 30)); // [объект Ross Vazquez, объект Elma Head, объект Carey Barr]
...
//   arr.reduce((acc, value) => acc + value.balance, 0);
// console.log('total baalance', getTotalBalance(users)); // 20916
...
// console.log(
//   'Friends of Briana Decker',
//   getUsersByFriend(users, 'Briana Decker'),
// ); // [ 'Sharlene Bush', 'Sheree Anthony' ]
// console.log(
//   'Friends of Goldie Gentry',
